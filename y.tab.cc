...
union YYSTYPE
{
#line 42 "shell.y" /* yacc.c:355  */

  char        *string_val;
  // Example of using a c++ type in yacc
  std::string *cpp_string;

#line 168 "y.tab.cc" /* yacc.c:355  */
};
...
{
       0,    71,    71,    75,    76,    79,    83,    87,    93,    97,
      98,   103,   110,   111,   115,   132,   140,   146,   151,   157,
     165,   173,   180,   181,   185,   188
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LESS", "PIPE", "TWOGREAT", "GREATAND", "GREATGREAT", "GREATGREATAND",
  "AMPERSAND", "$accept", "goal", "commands", "command", "simple_command",
  "pipe_list", "command_and_args", "argument_list", "argument",
  "command_word", "iomodifier_opt", "iomodifier_list", "background_opt", YY_NULLPTR
};
#endif
...
#line 157 "shell.y" /* yacc.c:1646  */
    {
  std::string * temp = new std::string((yyvsp[0].cpp_string)->c_str());
  Shell::_currentCommand._outFile = (yyvsp[0].cpp_string);
